	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/topup/515pay/pay", middleware.CriticalRateLimit(), controller.RequestTopup515pay)
		...
		subscriptionRoute.Use(middleware.UserAuth())
		{
			...
			subscriptionRoute.POST("/515pay/pay", middleware.CriticalRateLimit(), controller.SubscriptionRequest515pay)
		}
		...
		apiRouter.POST("/subscription/515pay/notify", controller.Subscription515payNotify)
